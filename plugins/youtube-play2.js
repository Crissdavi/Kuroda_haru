...
let lister = ["mp3","mp4", "mp3doc", "mp4doc", "ytvdoc"]
...
let q = '128kbps'
let txt = `*_𔓕꯭  ꯭ ꯭ ꯭ 𓏲꯭֟፝੭ ꯭𝓐𝓾𝓭𝓲𝓸 𓏲꯭֟፝੭ ꯭  ꯭ ꯭ ꯭𔓕_*\n\n`
...
let vid = res.videos[0]
let q = '360p'
let txt = `*_𔓕꯭  ꯭ ꯭ ꯭ 𓏲꯭֟፝੭ ꯭𝓥𝓲𝓭𝓮𝓸 𓏲꯭֟፝੭ ꯭  ꯭ ꯭ ꯭𔓕_*\n\n`
        txt += `        » 📚   *Título* : ${vid.title}\n`
        txt += `        » 🕒   *Duración* : ${vid.timestamp}\n`
        txt += `        » 👀   *Visitas* : ${vid.views}\n`
        txt += `        » 👤   *Autor* : ${vid.author.name}\n`
...
let vid = res.videos[0]
let q = '128kbps'
let txt = `*_𔓕꯭  ꯭ ꯭ ꯭ 𓏲꯭֟፝੭ ꯭𝓥𝓲𝓭𝓮𝓸𝓭𝓸𝓬 𓏲꯭֟፝੭ ꯭  ꯭ ꯭ ꯭𔓕_*\n\n`
        txt += `        » 📚   *Título* : ${vid.title}\n`
        txt += `        » 🕒   *Duración* : ${vid.timestamp}\n`
        txt += `        » 👀   *Visitas* : ${vid.views}\n`
        txt += `        » 👤   *Autor* : ${vid.author.name}\n`
...
let vid = res.videos[0]
let q = '360p'
let txt = `*_𔓕꯭  ꯭ ꯭ ꯭ 𓏲꯭֟፝੭ ꯭𝓐𝓾𝓭𝓲𝓸𝓭𝓸𝓬 𓏲꯭֟፝੭ ꯭  ꯭ ꯭ ꯭𔓕_*\n\n`
        txt += `        » 📚   *Título* : ${vid.title}\n`
        txt += `        » 🕒   *Duración* : ${vid.timestamp}\n`
        txt += `        » 👀   *Visitas* : ${vid.views}\n`
        txt += `        » 👤   *Autor* : ${vid.author.name}\n`
