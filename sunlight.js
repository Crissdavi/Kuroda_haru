...
global.authFile = 'KorodaSession'
global.authFileJB  = 'KorudaJadiBot'
...
mobile: MethodMobile, 
browser: opcion == '1' ? ['Koruda', 'Edge', '20.0.04'] : methodCodeQR ? ['Koruda', 'Edge', '20.0.04'] : ["Ubuntu", "Chrome", "20.0.04"],
auth: {
creds: state.creds,
...
const mainBotAuthFile = 'KorudaSession';
try {
